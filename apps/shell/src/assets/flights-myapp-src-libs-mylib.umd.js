(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@flights/myapp/src/libs/mylib', ['exports', '@angular/core', '@angular/common', '@angular/router'], factory) :
    (global = global || self, factory((global.flights = global.flights || {}, global.flights.myapp = global.flights.myapp || {}, global.flights.myapp.src = global.flights.myapp.src || {}, global.flights.myapp.src.libs = global.flights.myapp.src.libs || {}, global.flights.myapp.src.libs.mylib = {}), global.ng.core, global.ng.common, global.ng.router));
...
//# sourceMappingURL=flights-myapp-src-libs-mylib.umd.js.map
